 ...
 * @author dexxtronex
 */
public class Clase_aula_Laboratorio extends Aula{

    public Clase_aula_Laboratorio() {
    }

      private String[] dias;
    private int horaDisponibleInico,HoraFin;
    
    public Clase_aula_Laboratorio(String[] dias, int horaDisponibleInico, int HoraFin, String Numeracion_aula, int Capacidad_alumnos, int Cantidad_Pizarras, int numeros_pupitres, String tipo_ventilacion, int cantidad_ventilacion) {
    ...
    public void setHoraFin(int HoraFin) {
     ...
     private ArrayList<Aula> aulaLaboratorio;
    
    @Override
    public void registrar(Aula aula) {
        aulaLaboratorio.add(aula); 
    }

    @Override
    public Aula buscar(String codigo) {
         for(Aula aula:aulaLaboratorio){
