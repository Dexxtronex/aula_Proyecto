 ...
 * @author dexxtronex
 */
public class Clase_aula_Grande  extends Aula{

    public Clase_aula_Grande() {
    }

     private String[] dias;
    private int horaDisponibleInico,HoraFin;
    
    public Clase_aula_Grande(String[] dias, int horaDisponibleInico, int HoraFin, String Numeracion_aula, int Capacidad_alumnos, int Cantidad_Pizarras, int numeros_pupitres, String tipo_ventilacion, int cantidad_ventilacion) {
    ...
    private ArrayList<Aula> aulaGrande;
